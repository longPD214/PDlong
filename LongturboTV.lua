...
local function InitMainHub()
    ...
    -- NÚT NỔI BẬT/TẮT MENU (DÙNG NÚT ĐIỀU HƯỚNG BẤM TAY CHO ĐIỆN THOẠI & PC)
    Window:AddMinimizeButton({
        Button = { Image = "rbxassetid://7193356002", BackgroundTransparency = 0 },
        Corner = { CornerRadius = UDim.new(0, 6) }
    })

    -- Tạo GUI Nút Tròn Bật/Tắt Menu Riêng Độc Lập
